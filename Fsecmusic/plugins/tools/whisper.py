from Fsecmusic import app as bot
    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://graph.org/file/cb9394eec3d0ebce858f9.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="⦿ Whisper ⦿",
            description=f"@FSEC_MUSIC_BOT [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**❍ Usage:**\n\n@FSEC_MUSIC_BOT (Target Username or ID) (Your Message).\n\n**Example:**\n@FSEC_MUSIC_BOT @username I Wanna Phuck You"),
            thumb_url="https://graph.org/file/cb9394eec3d0ebce858f9.jpg",
            reply_markup=switch_btn
        )
    ]
