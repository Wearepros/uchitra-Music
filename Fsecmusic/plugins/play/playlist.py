...
from Fsecmusic.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from Fsecmusic import Carbon, app
from Fsecmusic.utils.decorators.language import language, languageCB
from Fsecmusic.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
...
from Fsecmusic.utils.stream.stream import stream
from typing import Dict, List, Union

from Fsecmusic.core.mongo import mongodb
...
@app.on_callback_query(filters.regex("falcon_playlist") & ~BANNED_USERS)
@languageCB
async def add_playlist(client, CallbackQuery, _):
    callback_data = CallbackQuery.data.strip()
    videoid = callback_data.split(None, 1)[1]
